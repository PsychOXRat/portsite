...
import crumpleImg from "../public/assets/images/PCG.png"
    ...
    <div className="w-full">
        <div className="w-screen h-[30vh] lg:h-[40vh] relative">
            ...
            <div className="absolute top-[85%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
              <h2 className="py-2">Procedural Content Generation</h2>
              <h3>Unity/C#</h3>
            </div>
        </div>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid grid-cols-1 md:grid-cols-5 gap-8 pt-8">
        <div className="md:col-span-3">
          ...
          <p>Developed as part of the Procedural Content Generation module, this was my first time trying to program anything PCG related and decided to make a desert wasteland scene complete with abandonded camps, rocks, foliage, and debris, as well as a number of AI vehicles that drive to and from the generated camps, all generated at runtime. </p>
          <Link href="https://drive.google.com/file/d/13Az9uvcTjinzrqYBl_WNHCInmQ7_Qm5R/view?usp=sharing">
        ...
        <div className=" flex md:col-span-2 shadow-xl shadow-[#00a3d9] rounded-xl p-4 bg-[#bbbbbb] aspect-video w-full">
          <YoutubeEmbed embedId="YmTkZHxMPOM" title={"PCG Video"}/>
        </div>

...
import crumpleImg from "../public/assets/images/AstroDestroyer.jpg"
    ...
    <div className="w-full">
        <div className="w-screen h-[30vh] lg:h-[40vh] relative">
            ...
            <div className="absolute top-[85%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
              <h2 className="py-2">Astro Destroyer</h2>
              <h3>Unity/C#</h3>
            </div>
        </div>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid grid-cols-1 md:grid-cols-5 gap-8 pt-8">
        <div className="md:col-span-3">
          ...
          <p>Astro Destroyer was a prototype made for the Norwich Gaming Festival in 2018 and was a reimagining of Asteroids, taking place in an enclosed space with enemy ships coming at you instead of the namesake asteroids. The gameplay is very simple, requiring the player to only use the WSAD keys and the spacebar to play. Because of this and the leaderboard system, there was never a moment where the game was left alone</p>
          <Link href="https://drive.google.com/file/d/1vdwVM2biELil8VhZ3E5l6xlPL_C6Kcht/view?usp=sharing">
        ...
        <div className=" flex md:col-span-2 shadow-xl shadow-[#00a3d9] rounded-xl p-4 bg-[#bbbbbb] aspect-video w-full">
          <YoutubeEmbed embedId="GSXr5VVnkD0" title={"Astro Destroyer"}/>
        </div>

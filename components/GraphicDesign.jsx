    ...
    <div id="" className="w-full md:h-1/2 p-2 flex items-center py-16">
        ...
        <div className="max-w-[1240px] mx-auto md:grid grid-cols-3 gap-8">
            <div className='col-span-2'>
                ...
                <p>
                The livery on display in the lower right was an adaptation I made of a livery for the AMW car from the cult classic game Re-Volt, after being commissioned to fit it onto the Mercedes AMG GT3 car in the iRacing simulator. This recreation and adaptation was made by finding the original game's livery image and AI upscaling it from 512x512 up to 1024x1024 in order to find a closer match for fonts and get a clearer view of the design itself. Once this was done I proceeded to create the base of the livery on the Mercedes' UV map, making some design decisions in order to let the livery work with the different shape of the Mercedes, most notably of which takes place on the bonnet of the car. I then created the individual sponsor logos that were visible on the original car and placed them in the same locations where possible. The client was pleased with the end result of this and would continue to commision me.
                    </p>
            </div>
